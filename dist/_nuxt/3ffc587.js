(window.webpackJsonp = window.webpackJsonp || []).push([
  [14],
  {
    554: function (t, e, n) {
      ...
      (0, n(18).default)("49f66f1c", content, !0, { sourceMap: !1 });
    },
    595: function (t, e, n) {
      "use strict";
      n(554);
    ...
    596: function (t, e, n) {
      ...
      o.push([
        t.i,
        ".notifications-container[data-v-cdc10228]{background-color:#f3f3f3;display:flex;justify-content:center;padding:20px;width:100%}.notifications-card[data-v-cdc10228]{background:#fff;border-radius:12px;box-shadow:0 2px 10px rgba(0,0,0,.1);max-width:750px!important;padding:10px;width:100%}@media (max-width:960px){.notifications-card[data-v-cdc10228]{max-width:90%}}@media (max-width:600px){.notifications-card[data-v-cdc10228]{max-width:95%}}.text-muted[data-v-cdc10228]{color:#757575}.notification-item[data-v-cdc10228]{background-color:#fff;min-height:80px;padding:12px 16px}.notification-title[data-v-cdc10228]{font-size:16px;font-weight:700}.notification-text[data-v-cdc10228]{font-size:14px}.v-divider[data-v-cdc10228]{margin:0}",
        "",
      ]),
        (o.locals = {}),
        (t.exports = o);
