(window.webpackJsonp = window.webpackJsonp || []).push([
  [0],
  {
    ...
    536: function (t, e, r) {
      ...
      e.a = Object(c.a)(
        ...
        computed: {
          classes: function () {
            return $(
              $(
                $(
                  $({ "v-chip": !0 }, w.a.options.computed.classes.call(this)),
                  {},
                  {
          ...
          isClickable: function () {
            return Boolean(
              w.a.options.computed.isClickable.call(this) || this.chipGroup
            );
          },
        },
        created: function () {
          ...
          [
            ...
            var r = Object(n.a)(e, 2),
              o = r[0],
              c = r[1];
            t.$attrs.hasOwnProperty(o) && Object(y.a)(o, c, t);
          });
        },
        methods: {
          click: function (t) {
        ...
        render: function (t) {
          ...
          return t(n, this.setTextColor(o, data), e);
        },
      });
    },
    578: function (t, e, r) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, r(18).default)("44600667", content, !0, { sourceMap: !1 });
    },
    579: function (t, e, r) {
      var n = r(17)(function (i) {
        return i[1];
    ...
    580: function (t, e, r) {
      "use strict";
      r(4)({ target: "Math", stat: !0 }, { sign: r(339) });
    },
    581: function (t, e, r) {
      var content = r(582);
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, r(18).default)("d67becdc", content, !0, { sourceMap: !1 });
    },
    582: function (t, e, r) {
      var n = r(17)(function (i) {
        return i[1];
    ...
    657: function (t, e, r) {
      ...
      function _(t) {
        var e = Math.abs(t);
        return Math.sign(t) * (e / ((1 / 0.501 - 2) * (1 - e) + 1));
      }
      function $(t, e, r, n) {
        var o = t.clientWidth,
          c = r ? e.content - t.offsetLeft - o : t.offsetLeft;
        r && (n = -n);
        var l = e.wrapper + n,
          h = o + c,
          v = 0.4 * o;
        return (
          c <= n
            ? (n = Math.max(c - v, 0))
            : l <= h && (n = Math.min(n - (l - h - v), e.content - e.wrapper)),
          r ? -n : n
        );
      }
      var k = Object(d.a)(l.a, h.a).extend({
          name: "base-slide-group",
          directives: { Resize: v.a, Touch: f.a },
          props: {
            ...
            showArrows: {
              ...
              validator: function (t) {
                return (
                  "boolean" == typeof t ||
                  ["always", "never", "desktop", "mobile"].includes(t)
                );
              },
            },
          },
          ...
          computed: {
            ...
            classes: function () {
              return O(
                O({}, l.a.options.computed.classes.call(this)),
                {},
                {
                  "v-slide-group": !0,
          ...
          mounted: function () {
            ...
            if ("undefined" != typeof ResizeObserver) {
              ...
              this.$on("hook:beforeUpdate", function () {
                var e;
                r = (
                  (null === (e = t.$refs.content) || void 0 === e
                    ? void 0
                    : e.children) || []
                ).length;
              }),
          ...
          methods: {
            ...
            genNext: function () {
              var t = this,
                slot = this.$scopedSlots.next
                  ...
                  : Object(m.n)(this, "next") || this.__cachedNext;
              return this.$createElement(
                "div",
                {
            ...
            genPrev: function () {
              var t = this,
                slot = this.$scopedSlots.prev
                  ...
                  : Object(m.n)(this, "prev") || this.__cachedPrev;
              return this.$createElement(
                "div",
                {
            ...
            genTransition: function (t) {
              return this.$createElement(c.c, [this.genIcon(t)]);
            },
            genWrapper: function () {
              var t = this;
              return this.$createElement(
            ...
            calculateNewOffset: function (t, e, r, n) {
              var o = r ? -1 : 1,
                c = o * n + ("prev" === t ? -1 : 1) * e.wrapper;
            ...
            onTouchMove: function (t) {
              if (this.canTouch) {
                if (!this.isSwiping) {
                  ...
                  (this.isSwipingHorizontal = Math.abs(e) > Math.abs(r)),
                    (this.isSwiping = !0);
                }
            ...
            onTouchEnd: function () {
              if (this.canTouch) {
                var t = this.$refs,
                  content = t.content,
                  e = t.wrapper,
                  r = content.clientWidth - e.clientWidth;
            ...
            scrollIntoView: function () {
              ...
              this.selectedItem &&
                ...
                (!this.centerActive && !this.isOverflowing)
                  ? (this.scrollOffset = 0)
                  : this.centerActive
                  ? (this.scrollOffset = (function (t, e, r) {
                      var n = t.offsetLeft,
                        o = t.clientWidth;
                      if (r) {
                        var c = e.content - n - o / 2 - e.wrapper / 2;
                        return -Math.min(e.content - e.wrapper, Math.max(0, c));
                      }
                      var l = n + o / 2 - e.wrapper / 2;
      ...
      e.a = Object(d.a)(k, j.a).extend({
        ...
        computed: {
          classes: function () {
            return P(
              P({}, k.options.computed.classes.call(this)),
              {},
              { "v-chip-group": !0, "v-chip-group--column": this.column }
            );
          },
        },
        watch: {
        ...
        methods: {
          genData: function () {
            return this.setTextColor(
              this.color,
              P({}, k.options.methods.genData.call(this))
            );
          },
        },
      });
